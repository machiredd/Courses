...
from ngrammodel import MaximumLikelihoodNGramModel,WittenBellNGramModel
...
result = open('output_wb.txt', 'w')
check = open('crosscheck_wb.txt','w')
actual = open('text_wb.txt','w')
